                ...
                static partial class Search
                {
                    ...
                    public static NRestResult<List<Models.Lane>> ByTSB(Models.TSB value)
                    {
                        var ret = Execute<List<Models.Lane>>(
                            RouteConsts.TA.Infrastructure.Lane.Search.ByTSB.Url, value);
                        return ret;
                    }
                    /// <summary>
                    ...
                    {
                        var ret = Execute<List<Models.Lane>>(
                            RouteConsts.TA.Infrastructure.Lane.Search.ByPlazaGroup.Url, value);
                        return ret;
                    }
                    /// <summary>
                    ...
                    {
                        var ret = Execute<List<Models.Lane>>(
                            RouteConsts.TA.Infrastructure.Lane.Search.ByPlaza.Url, value);
                        return ret;
                    }
                }
            }
