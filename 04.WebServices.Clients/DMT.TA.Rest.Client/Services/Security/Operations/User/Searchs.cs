                ...
                static partial class Search
                {
                    ...
                    public static NRestResult<Models.User> ById(Models.Search.User.ById value)
                    {
                        var ret = Execute<Models.User>(
                            RouteConsts.TA.Security.User.Search.ById.Url, value);
                        return ret;
                    }
                    /// <summary>
                    /// Gets User By CardId.
                    ...
                    {
                        var ret = Execute<Models.User>(
                            RouteConsts.TA.Security.User.Search.ByCardId.Url, value);
                        return ret;
                    }
                    /// <summary>
                    /// Gets User By LogIn.
                    ...
                    {
                        var ret = Execute<Models.User>(
                            RouteConsts.TA.Security.User.Search.ByLogIn.Url, value);
                        return ret;
                    }
                    ...
                    public static NRestResult<List<Models.User>> ByRoleId(Models.Search.User.ByRoleId value)
                    {
                        var ret = Execute<List<Models.User>>(
                            RouteConsts.TA.Security.User.Search.ByRoleId.Url, value);
                        return ret;
                    }
                    /// <summary>
                    ...
                    {
                        var ret = Execute<List<Models.User>>(
                            RouteConsts.TA.Security.User.Search.ByGroupId.Url, value);
                        return ret;
                    }
                    /// <summary>
                    ...
                    {
                        var ret = Execute<List<Models.User>>(
                            RouteConsts.TA.Security.User.Search.ByFilter.Url, value);
                        return ret;
                    }
                }
            }
